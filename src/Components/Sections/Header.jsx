    ...
    return (
        <header>
            <div className="header_Container" onMouseEnter={() => ShowHeader()} onMouseLeave={() => HideHeader()}>
                ...
                <span onClick={() => Scroll_To_Section1()} className="btnHeader btnHeader1" onMouseEnter={() => HoverCircles(".svg__fillCircle_Header1", ".title_90deg__Intro")} onMouseLeave={() => UnHoverCircles(".btnHeader1", ".svg__fillCircle_Header1", ".title_90deg__Intro")}>
                ...
                <span onClick={() => Scroll_To_Section2()} className="btnHeader btnHeader2" onMouseEnter={() => HoverCircles(".svg__fillCircle_Header2", ".title_90deg__PinkDrink")} onMouseLeave={() => UnHoverCircles(".btnHeader2", ".svg__fillCircle_Header2", ".title_90deg__PinkDrink")} >
                ...
                <span onClick={() => Scroll_To_Section3()} className="btnHeader btnHeader3" onMouseEnter={() => HoverCircles(".svg__fillCircle_Header3", ".title_90deg__History")} onMouseLeave={() => UnHoverCircles(".btnHeader3", ".svg__fillCircle_Header3", ".title_90deg__History")}>
                ...
                <span onClick={() => Scroll_To_Section4()} className="btnHeader btnHeader4" onMouseEnter={() => HoverCircles(".svg__fillCircle_Header4", ".title_90deg__Cocktails")} onMouseLeave={() => UnHoverCircles(".btnHeader4", ".svg__fillCircle_Header4", ".title_90deg__Cocktails")}>
                ...
                <span onClick={() => Scroll_To_Section5()} className="btnHeader btnHeader5" onMouseEnter={() => HoverCircles(".svg__fillCircle_Header5", ".title_90deg__Contacts")} onMouseLeave={() => UnHoverCircles(".btnHeader5", ".svg__fillCircle_Header5", ".title_90deg__Contacts")}>
