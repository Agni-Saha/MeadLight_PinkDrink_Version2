...
export default function Section4_btnSlider(props) {
    ...
    }, [props.svgCurve_className, tl_svg_curve])
    ...
    function Conditions_Open_Close_Captions(rootClassName) {
        ...
        if (el.style.display === "" || el.style.display === "none") {
            ...
            tl.fromTo(el, { display: 'none', height: 0 }, { display: 'block', height: 320, duration: 0.3 })
            ...
            tl.fromTo(el, { height: 320 }, { height: 0, duration: 0.3 }, "-=0.2")
