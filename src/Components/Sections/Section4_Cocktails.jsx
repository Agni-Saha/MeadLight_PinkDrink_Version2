...
import Section4btnSlider from './Components/Section4_btnSlider';
...
export default function Section4_Cocktails() {
    ...
    }, [tl_svg_curve1, tl_svg_curve2, tl_svg_curve3, tl_svg_curve4])
            ...
            <div className="Section4_Cocktails">
                <div>
                    ...
                    <div className="btnContainer">
                        <Section4btnSlider info={btnSlider_Info1} rootClassName={"btn_root_1"} title={"Spritzlight"} svgCurve_className={"svg__curve01"} widthSvg={170} />
                        <Section4btnSlider info={btnSlider_Info2} rootClassName={"btn_root_2"} title={"Principio Americano"} svgCurve_className={"svg__curve02"} widthSvg={340} />
                        <Section4btnSlider info={btnSlider_Info3} rootClassName={"btn_root_3"} title={"Red honey"} svgCurve_className={"svg__curve03"} widthSvg={175} />
                        <Section4btnSlider info={btnSlider_Info4} rootClassName={"btn_root_4"} title={"Mead & tonica"} svgCurve_className={"svg__curve04"} widthSvg={235} />
                    </div>
                </div>
            </div>
        </div>
