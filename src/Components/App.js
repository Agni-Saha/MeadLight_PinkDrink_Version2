import '../Css/App.css';
import Section1Intro from './Sections/Section1_Intro';
import Section2PinkDrink from './Sections/Section2_PinkDrink';
import Section3History from './Sections/Section3_History';
import Section5Contacts from './Sections/Section5_Contacts';
import Section4Cocktails from './Sections/Section4_Cocktails';
...
function App() {
    ...
    return (
        <section className="viewport">
            ...
            <CanvasController />
            <Header />
            <div onClick={() => Scroll_To_Sicover_Clicked()}
                onMouseEnter={() => PlaySvg()}
                onMouseLeave={() => ReverseSvg()}
                className="div__scroll_to_dicover"
            >
                <span className="line__before__scroll"></span>
                <span className="scroll__to__discover">
                    <SvgImport
                        svg={
                            <svg style={{ position: 'absolute', width: 92, top: -40, left: 20 }}
                                data-v-c2a89eaa=""
